...
public:
                   ...
                   HardwareContext &inHardware)
   {
      ...
      {
         mArrays = &ioData.GetArrays(mSurface, inJob.mProgram, false,(mSurface && (mSurface->GetAlphaMode() == amPremultiplied)) ? mGradFlags | HardwareArrays::AM_PREMULTIPLIED : mGradFlags);
